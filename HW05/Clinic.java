...
public class Clinic {
    ...
    public String nextDay(File file) throws FileNotFoundException {
        ...
        while (fileScan.hasNextLine()) {
            ...
            switch (type) {
                case "Dog":
                    petPatient = new Dog(name, health, painLevel, Double.parseDouble(mice));
                    break;
                case "Cat":
                    petPatient = new Cat(name, health, painLevel, Integer.parseInt(mice));
                    break;
                default:
                    throw new InvalidPetException();
            }
